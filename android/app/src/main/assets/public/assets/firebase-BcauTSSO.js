...
function __PRIVATE_remoteStoreUnlisten(e, t) {
  ...
  __PRIVATE_logDebug(Ht$1, "remoteStoreUnlisten removing mapping of SDK target ID to remote", t, i), n.Ta.delete(i), n.Ia.delete(t), n.Ea.delete(i), r.x_() && __PRIVATE_sendUnwatchRequest(n, i), 0 === n.Ta.size && (r.x_() ? r.B_() : __PRIVATE_canUseNetwork(n) && // Revert to OnlineState.Unknown if the watch stream is not open and we
...
async function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
  ...
  e.asyncQueue.enqueueRetryable((async () => {
    __PRIVATE_logDebug(Ht$1, "Retrying IndexedDB access"), await n(), e.Va.delete(
      1
      /* OfflineCause.IndexedDbFailed */
...
function __PRIVATE_ensureWriteStream(e) {
  ...
  (e.ya = (function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    ...
    await __PRIVATE_fillWritePipeline(e)) : (await e.ya.stop(), e.Pa.length > 0 && (__PRIVATE_logDebug(Ht$1, `Stopping write stream with ${e.Pa.length} pending writes`), e.Pa = []));
  }))), e.ya;
}
/**
 * @license
...
class OnlineComponentProvider {
  ...
  async terminate() {
    ...
    await (async function __PRIVATE_remoteStoreShutdown(e) {
      const t = __PRIVATE_debugCast(e);
      __PRIVATE_logDebug(Ht$1, "RemoteStore shutting down."), t.Va.add(
        5
...
function getFirestore(e, n) {
  const r = "object" == typeof e ? e : getApp(), i = "string" == typeof e ? e : n, s = _getProvider(r, "firestore").getImmediate({
    identifier: i
  });
  if (!s._initialized) {
...
class __PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
  ...
  isEqual(e) {
    return e instanceof __PRIVATE_ArrayUnionFieldValueImpl && deepEqual(this.Cc, e.Cc);
  }
}
class __PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
  ...
  isEqual(e) {
    return e instanceof __PRIVATE_ArrayRemoveFieldValueImpl && deepEqual(this.Cc, e.Cc);
  }
}
class __PRIVATE_NumericIncrementFieldValueImpl extends FieldValue {
  ...
  isEqual(e) {
    return e instanceof __PRIVATE_NumericIncrementFieldValueImpl && (this.vc === e.vc || Number.isNaN(this.vc) && Number.isNaN(e.vc));
  }
}
...
export {
  ...
  updateProfile as D,
  ref as E,
  uploadBytesResumable as F,
  GoogleAuthProvider as G,
  getDownloadURL as H,
  RecaptchaVerifier as R,
  getStorage as a,
  getAuth as b,
  signInWithPopup as c,
  signOut as d,
  addDoc as e,
  collection as f,
  getFirestore as g,
  ...
  query as q,
  limit as r,
  signInWithRedirect as s,
  getRedirectResult as t,
  updateDoc as u,
  createUserWithEmailAndPassword as v,
  signInWithEmailAndPassword as w,
  signInWithPhoneNumber as x,
  where as y,
  onAuthStateChanged as z
};
